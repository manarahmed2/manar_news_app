      ...
      body: Column(
        children: [
          Expanded(
            flex: 1,
            child: Image.asset(
              'assets/images/man.png', // تأكد من أن المسار صحيح هنا
              width: MediaQuery.of(context).size.width, // عرض الصورة بعرض الشاشة
              fit: BoxFit.cover, // لضمان ملء الصورة للحجم المحدد
            ),
          ),
          Expanded(
            flex: 1,
            child: Container(
              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    alignment: Alignment(0.0, -2), // تعديل المحاذاة لرفع المستطيل
                    child: Container(
                      width: 311,
                      height: 141,
                      decoration: BoxDecoration(
                        color: Color(0xF5D7D7D7),
